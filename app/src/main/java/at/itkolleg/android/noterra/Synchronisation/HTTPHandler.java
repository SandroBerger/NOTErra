 ...
 * der anschlie�end die Daten in die MySQL-Datenbank eintr�gt.
...
public class HTTPHandler {
    ...
    /**
     * Es werden alle Daten der Tabelle aus der Datenbank ausgelesen und anschlie�end
     * in eine Liste gespeichert.
     * Danach wird die Liste durchloffen und jeder Wert einzeln an das PHP-File �bergeben
     * Wurde die Tabelle erfolgreich hinaufgeladen, und der Responsecode 200 - OK zur�ckgegeben,
     * wird alles aus der Tabelle gel�scht.
    ...
    public class HTTPTask extends AsyncTask<Void, Void, Void> {
         ...
         * weiterverarbeitung und f�r das eintragen in die
         * MySQL-Datenbank
         * */
        @Override
